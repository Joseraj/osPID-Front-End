...
void CreateUI(String cardID, String tab, int top)
{
  ...
  } else if (cardID.equals("OID1"))
  {
    ...
    controlP5.addButton("Send_Output_Config")
      .setValue(0.0)
      .setPosition(configLeft, top + 180)
      .setSize(160, 20)
      ;     
    ...
    {
      controlP5.getController(names[i]).moveTo(tab);
      OutputControls.add(controlP5.getController(names[i]));
    }
    r3.moveTo(tab);  
  ...
  } else if (cardID.equals("IID0"))
  {
    ...
    protIr1.getItem(0).getCaptionLabel().getStyle().backgroundWidth = 45;
    protIr1.getItem(1).getCaptionLabel().getStyle().backgroundWidth = 45;
    ...
    protIr2.getItem(0).getCaptionLabel().getStyle().backgroundWidth = 45;
    protIr2.getItem(1).getCaptionLabel().getStyle().backgroundWidth = 45;
    ...
    protIr3.getItem(0).getCaptionLabel().getStyle().backgroundWidth = 45;
    protIr3.getItem(1).getCaptionLabel().getStyle().backgroundWidth = 45;
    ...
    protIr4.getItem(0).getCaptionLabel().getStyle().backgroundWidth = 45;
    protIr4.getItem(1).getCaptionLabel().getStyle().backgroundWidth = 45;
  ...
  } else if (cardID.equals("OID0"))
  {
    ...
    protOr1.getItem(0).getCaptionLabel().getStyle().backgroundWidth = 45;
    protOr1.getItem(1).getCaptionLabel().getStyle().backgroundWidth = 45;
    ...
    protOr2.getItem(0).getCaptionLabel().getStyle().backgroundWidth = 45;
    protOr2.getItem(1).getCaptionLabel().getStyle().backgroundWidth = 45;
    ...
    protOr3.getItem(0).getCaptionLabel().getStyle().backgroundWidth = 45;
    protOr3.getItem(1).getCaptionLabel().getStyle().backgroundWidth = 45;
    ...
    protOr4.getItem(0).getCaptionLabel().getStyle().backgroundWidth = 45;
    protOr4.getItem(1).getCaptionLabel().getStyle().backgroundWidth = 45;
